...
const OrderCard=({order,index})=>{
    ...
    return (
        <div
            ...
            className="flex flex-col md:flex-row border border-gray-300 rounded-md py-2 hover:cursor-pointer">
            ...
            <div className="w-full md:w-11/12 flex flex-col md:flex-row">
                <div className=" w-full md:w-1/4 flex flex-row justify-start">
                    <p><span className="md:hidden font-semibold">Name: </span>{order?.userId?.fullName??DEFAULT_NAME}</p>
                </div>
